...
public interface LawKnowledgeMapper extends BaseMapper<LawKnowledge, String> {
    ...
    List<LawKnowledge> getLatestThree(String systemTag);

    List<LawKnowledge> getAllTitle(String systemTag);
    ...
    Integer countLvshifuKnowledge(LawKnowledge lawKnowledge);

    List<LawKnowledge> listLvshifuKnowledgeByPage(LawKnowledge lawKnowledge);
}
